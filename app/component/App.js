    ...
    constructor(props, context){
      ...
      this.state = {
          navs: [
              ...
              {name: '示例', key: 1, url: '', child: [{name: '错误边界', key: 16, url: '/demo/error'}, {name: 'Portal', key: 17, url: '/demo/portal'}, {name: '验证测试', key: 18, url: '/demo/experiment'}, {name: '虚拟列表', key: 19, url: '/demo/list'}]},
